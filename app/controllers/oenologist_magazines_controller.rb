class OenologistMagazinesController < ApplicationController
  before_action :set_oenologist_magazine, only: %i[ show edit update destroy ]

  # GET /oenologist_magazines or /oenologist_magazines.json
  def index
    @oenologist_magazines = OenologistMagazine.all
  end

  # GET /oenologist_magazines/1 or /oenologist_magazines/1.json
  def show
  end
  ...
  # POST /oenologist_magazines or /oenologist_magazines.json
  def create
  ...
  # PATCH/PUT /oenologist_magazines/1 or /oenologist_magazines/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /oenologist_magazines/1 or /oenologist_magazines/1.json
  def destroy
